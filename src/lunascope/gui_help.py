...
WIDGET_HELP: dict[str, str] = {
    ...
    # Console / analysis
    "txt_inp": "Enter Luna commands/scripts here, then click Evaluate.",
    ...
    "butt_anal_exec": "Evaluate commands in txt_inp for the currently attached sample.",
    "butt_anal_refresh_exec": "Refresh the selected sample, then evaluate commands in txt_inp.",
...
ACTION_HELP: dict[str, str] = {
    ...
    "project_single_eval": "Evaluate commands for the currently attached sample.",
    "project_refresh_single_eval": "Refresh the selected sample, then evaluate commands for it.",
    "project_eval": "Evaluate commands in project mode across all visible samples.",
